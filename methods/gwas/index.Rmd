...
lambdagc.unadjusted = median(genotypes.13.assoc.linear$STAT^2, na.rm = TRUE)/median(qchisq(0.5, 1))
...
lambdagc.adjusted = median(genotypes.14.assoc.linear$STAT^2, na.rm = TRUE)/median(qchisq(0.5, 1))
